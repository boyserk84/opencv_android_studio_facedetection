 ...
 */
public class FacialDetectActivity extends Activity implements CameraBridgeViewBase.CvCameraViewListener2 {
    static{
    ...
    /**
     * Async loader for loading library and cascade data files for OpenCV.
     */
            ...
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    try {
                        ...
                        // This is a facial human structure data we feed to OpenCV so it can tell the difference
                        // between human and non-human faces.
    ...
    /** START OF CAMERA RELATED SECTION **/
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        // Draw green rectangles on each face OpenCV detects!
